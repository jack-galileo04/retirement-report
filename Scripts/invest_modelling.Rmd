...
# Assumptions:
- Modelling super returns using white noise (each monthly return is transformed normally distributed)
- CPI is modelled annually with a drift AR(1,0), and then months are interpolated from the years and scaled.
- Return factor for the month is (1+R)/(1+i) - 1.
...
```{r}
knitr::purl("invest_modelling.Rmd", here("Scripts/invest_modelling.R"))
```
